...
Article.facets :with => {:author_facet => 'John Watson'.to_crc32}
...
{% highlight ruby %}
@articles = Article.search('detection', :with => {:author_facet => 'Sherlock Holmes'.to_crc32}) # all 'detection' articles with author 'Sherlock Holmes'
...
Thinking Sphinx does not sort facet results. One option is to use Ruby's *sort*, or *sort_by* methods.
