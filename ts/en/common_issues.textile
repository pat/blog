...
h3. Vendored Delayed Job, AfterCommit and Riddle
...
While you can have string columns as attributes in Sphinx, they aren't stored as strings. Instead, Sphinx figures out the alphabetical order, and gives each string an integer value to make them useful for sorting. However, this means it's close to impossible to _filter_ on these attributes.
