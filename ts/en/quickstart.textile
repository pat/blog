...
Firstly, you'll need to install both "Sphinx":installing_sphinx.html and "Thinking Sphinx":installing_thinking_sphinx.html.

Once that's done, it's time to set up an index on your model. In the example below, we're assuming the model is the Article class.
