...
Sphinx _is_ available via MacPorts - but this comes with one important caveat: You must have MySQL and/or PostgreSQL installed via MacPorts as well. If you don't, then compiling by source is the best approach. Those instructions are found below in the UNIX section.
...
If you need PostgreSQL support, the path to the libraries will need to be explicitly set in configuration.
