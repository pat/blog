...
Vous pouvez cutomiser tout la configuration via des accesseurs sur l'instance d'InternalWorld dans le fichier @env.rb@.

Je vous recommande de jeter un coup d'oeil sur "la librairie Delta Asynchrone":http://github.com/freelancing-god/ts-delayed-delta/ pour vous inspirer.
