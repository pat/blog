...
<div class="comments">
<div class="comment-author">"Harry":http://harrylove.org left a comment on 26 Sep, 2011:</div>
...
<div class="comment-author">Dave T left a comment on 26 Sep, 2011:</div>
...
<div class="comment-author">Mark left a comment on 27 Sep, 2011:</div>
...
<div class="comment-author">"David Backeus":http://perfectskies.com left a comment on 27 Sep, 2011:</div>
...
<div class="comment-author">"pat":http://freelancing-gods.com left a comment on 27 Sep, 2011:</div>
...
<div class="comment-author">Lee Hambley left a comment on 27 Sep, 2011:</div>
...
<div class="comment-author">Frederic left a comment on 27 Sep, 2011:</div>
...
Or instead of a "version" attribute, use a "level" one, like described in "RFC 2854 (The 'text/html' Media Type)":http://tools.ietf.org/html/rfc2854
</div>
...
<div class="comment-author">"Kunal":http://urtak.com/ left a comment on 27 Sep, 2011:</div>
...
<div class="comment-author">"Jonathan Rochkind":http://bibwild.wordpress.com left a comment on 27 Sep, 2011:</div>
...
<div class="comment-author">"dagi3d":http://dagi3d.net left a comment on 28 Sep, 2011:</div>
...
<div class="comment-author">"Jeroen van Dijk":http://www.zwapp.com left a comment on  1 Oct, 2011:</div>
...
<div class="comment-author">"pat":http://freelancing-gods.com left a comment on  1 Oct, 2011:</div>
...
<div class="comment-author">Nadav left a comment on  2 Oct, 2011:</div>
...
<div class="comment-author">"Thorsten":http://mt7.de left a comment on 11 Oct, 2011:</div>
...
<div class="comment-author">"Thorsten":http://mt7.de left a comment on 12 Oct, 2011:</div>

<div class="comment">
Okay, my last comment missed the point. Your solution does work! My problem came from a gem we use together with your constraints way: "routing-filter":https://github.com/svenfuchs/routing-filter . Inside that, the handling of blocks is interrupted in the way Rails (or rack-mount) expects it.

Sorry for blaming your way for it ;-)
</div>

<div class="comment-author">Glenn left a comment on  3 Apr, 2012:</div>
...
<div class="comment-author">Miguel left a comment on 20 Nov, 2012:</div>
...
<div class="comment-author">"pat":http://freelancing-gods.com left a comment on 20 Nov, 2012:</div>

<div class="comment">
Hi Miguel

The HTTP methods in RSpec (get, post, put, delete) all accept a third parameter for headers, so you can specify authentication and version headers through that easily enough. Here's a "quick example":https://gist.github.com/4121959.

Using that approach, you can have tests for each version of each API call, checking for the appropriate behaviour.
</div>

<div class="comment-author">Vadim Golub left a comment on 22 Jul, 2013:</div>
